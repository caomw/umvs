...
parser = argparse.ArgumentParser(description="UMVSNet args")
...
parser.add_argument("--datapath", default="/media/data2/datasets/DTU_Dataset/dtu_training", type=str)
...
parser.add_argument("--dataset_name", type=str, default="dtu", choices=["dtu", "general_eval"])
...
parser.add_argument('--perc', type=float, default=0.01)
